...
public class FLanguageLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"WS", "Integer", "Real", "Boolean", "LPAREN", "RPAREN", "QUOTE", "SETQ", 
			"FUNC", "LAMBDA", "PROG", "COND", "WHILE", "RETURN", "BREAK", "HEAD", 
			"TAIL", "CONS", "EQUAL", "NONEQUAL", "LESS", "LESSEQ", "GREATER", "GREATEREQ", 
			"ISINT", "ISREAL", "ISBOOL", "ISNULL", "ISATOM", "ISLIST", "AND", "OR", 
			"XOR", "NOT", "EVAL", "COMMA", "PLUS", "MINUS", "MULT", "DIV", "MOD", 
			"NULL", "Identifier"
		};
	}
